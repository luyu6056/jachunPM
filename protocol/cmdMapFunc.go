...
var cmdMapFunc = map[int32]func(*libraries.MsgBuffer) MSG_DATA{
	...
	-1094408447: func(buf *libraries.MsgBuffer) MSG_DATA {return MSG_DATA(READ_MSG_HOST_getCenterSvrId_result(buf))},
	...
	-554136831: func(buf *libraries.MsgBuffer) MSG_DATA {return MSG_DATA(READ_MSG_HOST_getCenterSvrId(buf))},
...
var CmdToName = map[int32]string{
	...
	-1094408447: `MSG_HOST_getCenterSvrId_result`,
	...
	-554136831: `MSG_HOST_getCenterSvrId`,
