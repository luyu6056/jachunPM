...
func main() {
	...
	for _, name := range list {
		...
		str = strings.ReplaceAll(str, `{{include '../../common/view/action.html.php'}}`, `{{template "action.html" .}}`)
		str = strings.ReplaceAll(str, `{{include '../../common/view/datepicker.html.php'}}`, `{{template "datepicker.html" .}}`)
		str = strings.ReplaceAll(str, `{{include '../../common/view/customfield.html.php'}}`, `{{template "customfield.html" .}}`)
		str = strings.ReplaceAll(str, `.Lang.arrow`, `.Lang.common.arrow`)
